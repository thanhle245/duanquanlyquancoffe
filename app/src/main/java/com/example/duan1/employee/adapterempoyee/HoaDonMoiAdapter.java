...
public class HoaDonMoiAdapter extends FirebaseRecyclerAdapter<HoaDonMoi, HoaDonMoiAdapter.CartViewHolder> {
     ...
     * @param options
     */
    public HoaDonMoiAdapter(@NonNull FirebaseRecyclerOptions<HoaDonMoi> options,Context context) {
        super(options);
    ...
    @Override
    protected void onBindViewHolder(@NonNull HoaDonMoiAdapter.CartViewHolder holder, int position, @NonNull HoaDonMoi model) {
    ...
    @NonNull
    @Override
    public HoaDonMoiAdapter.CartViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_hoadonmoi, parent, false);
        return new HoaDonMoiAdapter.CartViewHolder(view);
    }
