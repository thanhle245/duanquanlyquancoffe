...
public class ThemSanPhamUong extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_them_san_pham_uong);
        uploadProgress = findViewById(R.id.uploadProgress);
        chooseImage = findViewById(R.id.chooseImage);
        btnUploadImage = findViewById(R.id.btnUploadImage);
        imgPreview = findViewById(R.id.imgPreview);
        addtensp = findViewById(R.id.addtenspuong);
        addgiasp = findViewById(R.id.addgiaspuong);
        addsoluong = findViewById(R.id.addslspuong);
        addgioithieu = findViewById(R.id.addgioithieuuong);

        mStorageRef = FirebaseStorage.getInstance().getReference("SanPhamUong");
        mDatabaseRef = FirebaseDatabase.getInstance().getReference("SanPhamUong");

        btnUploadImage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (mUploadTask != null && mUploadTask.isInProgress()) {
                    Toast.makeText(ThemSanPhamUong.this, "Upload in progress", Toast.LENGTH_LONG).show();
                } else {
                    uploadImage();
                }
            }
    ...
    private void uploadImage() {
        if (imgUrl != null) {
            ...
            mUploadTask = fileReference.putFile(imgUrl)
                            ...
                            fileReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    if (ten.isEmpty() || gia.isEmpty()|| soluong.isEmpty()|| gioithieu.isEmpty()){
                                        ...
                                        Toast.makeText(ThemSanPhamUong.this, "Upload successfully", Toast.LENGTH_LONG).show();
                                        addtensp.setText("");
                                        addsoluong.setText("");
                                        addgiasp.setText("");
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(ThemSanPhamUong.this, e.getMessage(), Toast.LENGTH_LONG).show();
                        }
                    })
            ...
            Toast.makeText(ThemSanPhamUong.this, "No file selected", Toast.LENGTH_SHORT).show();
        }
    }
}