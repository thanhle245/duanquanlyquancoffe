...
public class SanPhamUongAdAdapter extends FirebaseRecyclerAdapter<SanPhamAd, SanPhamUongAdAdapter.CartViewHolder> {
    ...
    public SanPhamUongAdAdapter(@NonNull FirebaseRecyclerOptions<SanPhamAd> options, Context context) {
        super(options);
                ...
                btn_xacnhan.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (tensp.getText().toString().isEmpty() || gia.getText().toString().isEmpty() || soluong.getText().toString().isEmpty() || gioithieu.getText().toString().isEmpty()) {
                            ...
                            FirebaseDatabase.getInstance().getReference().child("SanPhamUong")
