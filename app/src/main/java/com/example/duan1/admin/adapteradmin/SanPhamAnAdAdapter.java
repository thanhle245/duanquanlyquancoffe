...
public class SanPhamAnAdAdapter extends FirebaseRecyclerAdapter<SanPhamAd, SanPhamAnAdAdapter.CartViewHolder> {
    ...
    public SanPhamAnAdAdapter(@NonNull FirebaseRecyclerOptions<SanPhamAd> options, Context context) {
        super(options);
        this.context = context;
    }

    @Override
    protected void onBindViewHolder(@NonNull SanPhamAnAdAdapter.CartViewHolder holder, int position, @NonNull SanPhamAd model) {
                ...
                btn_xacnhan.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (tensp.getText().toString().isEmpty() || gia.getText().toString().isEmpty() || soluong.getText().toString().isEmpty() || gioithieu.getText().toString().isEmpty()) {
                            ...
                            FirebaseDatabase.getInstance().getReference().child("SanPhamAn")
    ...
    @NonNull
    @Override
    public SanPhamAnAdAdapter.CartViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_sanphamad, parent, false);
        return new SanPhamAnAdAdapter.CartViewHolder(view);
    }
